                    ...
                    <div class="row">
                                        ...
                                        <div class=" gallery gallery-fw" data-item-height="450">
                                            ...
                                            foreach ($gambar as $key => $gambar) :
                                                if ($kamar['id_tipe_kamar'] == $gambar['id_tipe_kamar']) {
                                                    ...
                                                    if ($i < 1) {
                                                        echo '
                                                    <div class="gallery-item" data-image="' . base_url() . '/uploads/kamar/' . $gambar['image'] . '" data-title="image ' . $i . '"></div>
                                                ';
                                                    } else  if ($i == 1) {
                                                        echo '
                                                    <div class="gallery-item" data-image="' . base_url() . '/uploads/kamar/' . $gambar['image'] . '" data-title="image ' . $i . '">
                                                        <div>+</div>
                                                    </div>
                                                ';
                                                    } else {
                        ...
                        <div class="col-lg-5">
                            ...
                            <form action="<?= site_url('/penghuni/penyewaan') ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="firstPay" id="firstPay" value="yes">
