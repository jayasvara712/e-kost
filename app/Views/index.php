        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <!-- filter -->
                    <div class="buttons">
                        <form action="<?= site_url('/') ?>" method="POST" style="display: inline-block;">
                            <?= csrf_field() ?>
                            ...
                            <li class="media">
                                ...
                                <div class="media-body col-lg-9">
                                    ...
                                    <div class="float-right">
                                        <a href="/kamar_detail/<?= $kamar['id_kamar'] ?>" class="btn btn-info">Lihat Kamar <i class="fas fa-arrow-alt-circle-right"></i></a>
                                    </div>
                                </div>
                            </li>
                        </ul>
